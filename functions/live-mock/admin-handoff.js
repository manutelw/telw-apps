...
export async function onRequestPost(context){
  ...
  const html='<!doctype html><meta charset="utf-8"><title>Opening Live Mock</title><script>localStorage.setItem("live_mock_student_session",'+JSON.stringify(safe)+');localStorage.setItem("live_mock_student_session",JSON.parse(localStorage.getItem("live_mock_student_session")));location.replace("/live-mock/interview.html");</script><p>Opening Live Mock…</p>';
